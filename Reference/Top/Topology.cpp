...
// Referenceerence Implementation Components

Reference::RecvBuffImpl recvBuffComp("RBC");

Reference::SendBuffImpl sendBuffComp("SBC");
...
Reference::PingReceiverComponentImpl pingRcvr("PngRecv");
...
Reference::SignalGen SG1("signalGen1");

Reference::SignalGen SG2("signalGen2");

Reference::SignalGen SG3("signalGen3");

Reference::SignalGen SG4("signalGen4");

Reference::SignalGen SG5("signalGen5");
...
bool constructApp(bool dump, U32 port_number, char* hostname) {
    ...
    constructReferenceArchitecture();
