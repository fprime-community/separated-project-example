module Reference {
    ...
    priority 140 \
  {
    ...
    // Declared in ReferenceTopologyDefs.cpp
    """
  ...
  instance pingRcvr: Reference.PingReceiver base id 0x0A00 \
    queue size Default.queueSize \
    stack size Default.stackSize \
    priority 100
  ...
  instance SG1: Reference.SignalGen base id 0x2100 \
    queue size Default.queueSize

  instance SG2: Reference.SignalGen base id 0x2200 \
    queue size Default.queueSize

  instance SG3: Reference.SignalGen base id 0x2300 \
    queue size Default.queueSize

  instance SG4: Reference.SignalGen base id 0x2400 \
    queue size Default.queueSize

  instance SG5: Reference.SignalGen base id 0x2500 \
    queue size Default.queueSize

  instance sendBuffComp: Reference.SendBuff base id 0x2600 \
    queue size Default.queueSize
  ...
  instance recvBuffComp: Reference.RecvBuff base id 0x4700
